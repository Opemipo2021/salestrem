      ...
      <div className='lg:col-span-2'>
        <div className='flex flex-col rounded-xl bg-background-80 gap-y-6 p-5 border-[1px] overflow-hidden border-in-active'>
          <div>
            ...
            <p className='text-text-secondary'>All live Automations will appear hear.</p>
          </div>
              ...
              {[1, 2, 3].map((item) => (
                ...
                className='flex items-start justify-between'>
                    <div className='flex flex-col'>
                      <h3 className='font-medium'>Direct all traffic to website.</h3>
                      <p className='text-text-secondary text-sm'>29th January, 2025</p>
                    </div>
                    <Check />
                </div>
              ))}
